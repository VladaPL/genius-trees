  ...
  return (
    ...
    <div class="wrapper promo__wrapper">
        <div class="promo__content">
            ...
            <p class="promo__text">Trees are real geniuses of nature. Trees generate life. Create life by planting trees. We will tell you about this in our project.</p>
...
return (
  <section class="tools">
        <div class="wrapper tools__wrapper">
            <h2 class="tools__title">The ability to plant trees is your superpower</h2>
            <div class="layout-4-column tool-container">
                <div class="tool">
                    ...
                    <p class="tool__text">Learn how to find the right seeds and germinate them</p>
                </div>
                <div class="tool">
                    <div class="tool__icon">
                ...
                <div class="tool">
                    ...
                    <p class="tool__text">Find a comfortable suitable place for your tree</p>
                </div>
                <div class="tool">
                    <div class="tool__icon">
  ...
  return (
    <section class="strategies">
        <div class="wrapper">
            ...
            <p class="strategies__description">There are more than 40,000 active and kind people in our community. Join now!</p>
            ...
            <div class="layout-3-column strategy-wrapper">
                <article class="strategy block-shadowed">
                    <img class="strategy__image" src="./img/img-small/pexels-veeterzy-38136.jpg" alt="strategy"/>
                ...
                <article class="strategy block-shadowed">
                    <img class="strategy__image" src="./img/img-small/pexels-veeterzy-38136.jpg" alt="strategy"/>
                    <div class="strategy__content">
                        <h3 class="strategy__name">Success Steps For Your Personal Or Life of Nature</h3>
                        <div class="strategy__tags tags">
                            <span class="tag tag_colored">Climate</span>
                            <span class="tag tag_colored">Landscape</span>
                            <span class="tag tag_colored">Trees</span>
